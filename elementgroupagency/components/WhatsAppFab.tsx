...
// Botão flutuante de WhatsApp — contacto imediato de baixo compromisso.
// Complementa o CTA principal (formulário) sem competir com ele.
export default function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-30 grid place-items-center w-14 h-14 rounded-full
                 bg-[#25D366] text-white shadow-[0_10px_30px_-6px_rgba(37,211,102,0.6)]
                 ring-1 ring-black/10 transition-transform duration-300 hover:scale-105 active:scale-95"
    >
