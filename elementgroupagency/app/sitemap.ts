...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const core: MetadataRoute.Sitemap = [
    ...
    { url: url('/servicos/reservas-pagamentos'), changeFrequency: 'monthly', priority: 0.9 },
    { url: url('/servicos/visibilidade-ia'),  changeFrequency: 'monthly', priority: 0.9 },
    { url: url('/servicos/diagnostico-ia'),   changeFrequency: 'monthly', priority: 0.9 },
    { url: url('/servicos/software'),         changeFrequency: 'monthly', priority: 0.85 },
    { url: url('/servicos/assistente-ia'),    changeFrequency: 'monthly', priority: 0.85 },
    { url: url('/servicos/design'),           changeFrequency: 'monthly', priority: 0.85 },
